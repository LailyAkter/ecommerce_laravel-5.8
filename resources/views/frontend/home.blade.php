...
<section id="home-section" class="hero">
    <div class="home-slider owl-carousel">
        <div class="slider-item" style="background-image: url({{asset('storage/category/slider/juice-2020-02-18-5e4b717bc49e8.jpg')}});">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    ...
                    <img style="height:300px;width:250px" class="img-fluid" src="{{asset('storage/product/'.$product->image)}}" alt="Colorlib Template">
